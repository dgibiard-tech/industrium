...
function addInterior(scene: THREE.Scene, interior: NonNullable<Interior>) {
  ...
  const interiorPanorama=interior.kind==="factory"?"/assets/factory-interior-360-v5.png":interior.kind==="warehouse"?"/assets/warehouse-interior-360-v5.png":"/assets/headquarters-interior-360-v2.png";
  const environmentTexture=new THREE.TextureLoader().load(interiorPanorama);environmentTexture.colorSpace=THREE.SRGBColorSpace;environmentTexture.mapping=THREE.EquirectangularReflectionMapping;scene.background=environmentTexture;scene.environment=environmentTexture;scene.userData.environmentTexture=environmentTexture;
